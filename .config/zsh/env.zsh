...
# Haskell things
[ -f "/home/jcruz/.ghcup/env" ] && . "/home/jcruz/.ghcup/env" # ghcup-env

# ana-ana-anaconda-clap-clap
export PATH=~/anaconda3/bin:$PATH

# >>> conda initialize >>>
# !! Contents within this block are managed by 'conda init' !!
__conda_setup="$('/home/jcruz/anaconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/jcruz/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/home/jcruz/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/jcruz/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
...
export PATH="$HOME/Descargas/nvim-linux64/bin:$PATH"
...
export XDG_DESKTOP_DIR="$HOME/Escritorio/"
...
# Para usar neovim descargado nightly
