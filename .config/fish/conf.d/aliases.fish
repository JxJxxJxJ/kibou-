...
# colorizar output, bueno para logfiles 
alias grep='grep --color=auto'
alias egrep='egrep --color=auto'
alias fgrep='fgrep --color=auto'

# confirmar antes de overwritear algo 
alias mv='mv -iv'
alias cp='cp -ivr'
alias rm='rm -ivr'
...
#
# # bat >> cat
# FIX: Todo fix, hacerlo andar en fish
